...
resource "discord_channel_permission" "g_n_ral_voice_everyone_role_perm" {
  channel_id   = discord_voice_channel.g_n_ral_voice.id
  type         = "role"
  overwrite_id = local.role_ids.everyone
  allow        = local.perms.none
  deny         = local.perm_bits.view_channel
...
resource "discord_channel_permission" "g_n_ral_voice_membre_role_perm" {
  channel_id   = discord_voice_channel.g_n_ral_voice.id
  type         = "role"
  overwrite_id = local.role_ids.membre
  allow        = local.perms.staff_view
...
resource "discord_channel_permission" "g_n_ral_voice_gm_role_perm" {
  channel_id   = discord_voice_channel.g_n_ral_voice.id
  type         = "role"
  overwrite_id = local.role_ids.gm
  allow        = local.perms.staff_view
...
resource "discord_channel_permission" "g_n_ral_voice_copain_role_perm" {
  channel_id   = discord_voice_channel.g_n_ral_voice.id
  type         = "role"
  overwrite_id = local.role_ids.copain
  allow        = local.perms.voice_basic
...
resource "discord_channel_permission" "g_n_ral_voice_officier_role_perm" {
  channel_id   = discord_voice_channel.g_n_ral_voice.id
  type         = "role"
  overwrite_id = local.role_ids.officier
  allow        = local.perms.staff_view
