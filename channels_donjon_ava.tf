...
resource "discord_channel_permission" "events_ava_text_membre_role_perm" {
  channel_id   = discord_text_channel.events_ava_text.id
  type         = "role"
  overwrite_id = local.role_ids.membre
  allow        = local.perms.forum_read_write
  deny         = local.perms.none
...
resource "discord_channel_permission" "events_ava_text_copain_role_perm" {
  channel_id   = discord_text_channel.events_ava_text.id
  type         = "role"
  overwrite_id = local.role_ids.copain
  allow        = local.perms.forum_read_write_extended
...
resource "discord_channel_permission" "build_ava_forum_membre_role_perm" {
  channel_id   = discord_forum_channel.build_ava_forum.id
  type         = "role"
  overwrite_id = local.role_ids.membre
  allow        = local.perms.forum_read_write
  deny         = local.perms.none
...
resource "discord_channel_permission" "build_ava_forum_copain_role_perm" {
  channel_id   = discord_forum_channel.build_ava_forum.id
  type         = "role"
  overwrite_id = local.role_ids.copain
  allow        = local.perms.forum_read_write_extended
